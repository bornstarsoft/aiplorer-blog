...
`data/codex_reset_history.json` contains a manually checked snapshot of 49
public Codex reset announcements observed between September 17, 2025 and August
31, 2026. Each row stores only the UTC observed-event timestamp and the source X
