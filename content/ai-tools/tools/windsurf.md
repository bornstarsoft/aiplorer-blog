...
bestFor:
  - Drafting developer workflow ideas
  - Exploring codebase changes
  - Preparing debugging or refactoring notes
  - Reviewing coding assistant needs
...
useCases:
  ...
  - Prepare debugging or refactoring plans
  - Compare coding workflow needs before choosing a tool
  - Document repository, secret, license, and policy checks before use
pros:
  - May help users think through coding tasks and workflow ideas
  - Can be useful for drafting, explanation, debugging, and refactoring planning
  - May support developers who want AI assistance in a coding workflow
limitations:
