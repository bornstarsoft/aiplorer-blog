...
bestFor:
  - Drafting code changes for review
  - Exploring codebase questions
  - Preparing debugging ideas
  - Reviewing developer workflow needs
...
useCases:
  ...
  - Prepare debugging or refactoring ideas
  - Compare coding workflow needs before choosing a tool
  - Document repository, secret, and workplace-policy checks before use
pros:
  - May help users explore coding tasks and implementation ideas
  - Can be useful for drafting, editing, explanation, and review planning
  - May support developers who want coding assistance in an editor-like workflow
limitations:
